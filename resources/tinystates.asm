...
org $80F600
print pc, " tinystates bank $80 start"

; These can be modified to do game-specific things before and after saving and loading
; Both A and X/Y are 16-bit here
pre_load_state:
{
    LDA $07F3 : STA !SRAM_MUSIC_DATA
    LDA $07F5 : STA !SRAM_MUSIC_TRACK
    LDA $0686 : STA !SRAM_SOUND_TIMER
...
post_load_music:
{
  ...
  .no_music_data
    ...
    LDA !SRAM_MUSIC_DATA : CMP $07F3 : BEQ .music_queue_increase_timer

    ; Insert queued music data
    DEX : DEX : TXA : AND #$000E : TAX
    LDA #$FF00 : CLC : ADC $07F3 : STA $0619,X
    LDA #$0008 : STA $0629,X
  ...
  .music_queue_empty
    LDA !SRAM_MUSIC_DATA : CMP $07F3 : BNE .clear_track_load_data
    BRA .check_track

  .clear_track_load_data
    LDA #$0000 : JSL $808FC1
    LDA #$FF00 : CLC : ADC $07F3 : JSL $808FC1
    BRA .load_track
  ...
  .check_track
    LDA !SRAM_MUSIC_TRACK : CMP $07F5 : BEQ .done
...
load_return:
{
    ...
    LDA !sram_ctrl_load_state : STA $8F : STA $97

    JSL tinystates_load_kraid

    ; pause menu graphics
    LDA $0998 : CMP #$0010 : BPL .not_paused
...
print pc, " tinystates bank $80 end"
warnpc $80FC00


org $82FE00
print pc, " tinystates bank $82 start"
...
print pc, " tinystates bank $82 end"
